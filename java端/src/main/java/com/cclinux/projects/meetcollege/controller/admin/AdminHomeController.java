...
import com.cclinux.projects.meetcollege.service.admin.AdminHomeService;
...
@RestController("MeetCollegeAdminHomeController")
public class AdminHomeController extends BaseMyAdminController {

    @Resource(name = "MeetCollegeAdminHomeService")
