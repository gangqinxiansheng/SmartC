...
import com.cclinux.projects.meetcollege.service.admin.AdminNewsService;
...
@RestController("MeetCollegeAdminNewsController")
public class AdminNewsController extends BaseMyAdminController {

    @Resource(name = "MeetCollegeAdminNewsService")
