...
import com.cclinux.projects.meetcollege.service.cust.PassportService;
...
@RestController("MeetCollegePassportController")
public class PassportController extends BaseMyCustController {

    @Resource(name = "MeetCollegePassportService")
