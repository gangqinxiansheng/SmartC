...
import com.cclinux.projects.meetcollege.service.admin.AdminMeetService;
import com.cclinux.projects.meetcollege.service.cust.MeetService;
...
@RestController("MeetCollegeAdminMeetController")
public class AdminMeetController extends BaseMyAdminController {

    @Resource(name = "MeetCollegeAdminMeetService")
    private AdminMeetService adminMeetService;

    @Resource(name = "MeetCollegeMeetService")
