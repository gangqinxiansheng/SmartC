...
import com.cclinux.projects.meetcollege.service.admin.AdminUserService;
...
@RestController("MeetCollegeAdminUserController")
public class AdminUserController extends BaseMyAdminController {

    @Resource(name = "MeetCollegeAdminUserService")
